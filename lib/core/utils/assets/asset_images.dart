...
class AssetsImg {
  ...
  static String forgetPassword = '$imgPath/forget_password.png';
  ...
  static String jobImage = '$imgPath/job.png';
  static String activeImage = '$imgPath/active.png';
  static String studentImage = '$imgPath/student.png';
  static String iconFilterImage = '$imgPath/Vector.png';
  static String approveImage = '$imgPath/approve.png';
  static String undoImage = '$imgPath/undo.png';
  static String rejectImage = '$imgPath/reject.png';
